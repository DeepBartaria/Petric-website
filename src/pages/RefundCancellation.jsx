...
export default function RefundCancellation() {
    ...
    return (
      <> 
        <SEO
          title="Refund & Cancellation Policy | Petric"
          description="Read Petric's refund and cancellation policy. Easy returns and hassle-free cancellations on all pet food and supply orders. We've got you covered."
          canonical="https://petric.in/refund-cancellation"  
        />  
