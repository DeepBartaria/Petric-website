      ...
      <div className="petric-landing">
        ...
        <div className="section">
          ...
          <div className="cat-grid">
            {shopCategories.map((category) => (
              <a key={category.id} href={`https://www.petric.in/category/${createSlug(category.name)}`} className="cat-card">
                {category.img ? (
        ...
        <div className="section">
          <div className="mb-10">
            <div className="section-header" style={{ marginBottom: "20px" }}>
              <div className="section-title">We Offer 200+ Brands </div>
        ...
        <div className="why-section">
          ...
          <div className="grid grid-cols-3 gap-2.5 w-full">
            <div className="why-card col-span-2 relative">
              ...
              <div className="why-title relative z-10">100% Authentic products </div>
            ...
            <div className="why-card col-span-1 relative">
              ...
              <div className="why-desc relative z-10">Your pet product's needs, sorted </div>
            </div>
            <div className="why-card col-span-1 relative">
              ...
              <div className="why-title relative z-10">Delivered in minutes, not hours </div>
            ...
            <div className="why-card col-span-1 relative">
              ...
              <div className="why-desc relative z-10">Lowest price, guaranteed </div>
            </div>
            <div className="why-card col-span-1 relative">
              ...
              <div className="why-desc relative z-10">What you see is what you pay, always </div>
            </div>
          </div>
        </div>
        ...
        <div className="final-cta">
          ...
          <div className="final-cta-btns">
            <a href="https://wa.me/918295756962" className="btn-outline-dark">Enquire on WhatsApp</a>
