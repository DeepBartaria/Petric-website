...
export default function ShippingAndDelivery() {
    ...
    return (
        <>
            <SEO
                title="SShipping & Delivery Policy | Petric"
                description="Learn about Petric's shipping and delivery policy. We deliver pet food and supplies across Gurgaon in 59 minutes."
                canonical="https://petric.in/shipping-and-delivery"  
            />
