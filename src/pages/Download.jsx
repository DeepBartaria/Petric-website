...
export default function Download() {
    ...
    return (
        <>
            <SEO
                title="Download the Petric App for Exclusive Offers in Gurgaon"
                description="Download the Petric app for iOS and Android. Order pet food, medicines, treats and supplies in Gurgaon in 59 minutes." 
                canonical="https://petric.in/download"
            />
