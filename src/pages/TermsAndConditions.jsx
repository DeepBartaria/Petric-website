...
export default function TermsAndConditions() {
    ...
    return (
        <>
            <SEO
                title="Terms & Conditions | Petric "
                description="Read the terms and conditions governing your use of Petric's pet supply delivery service in Gurgaon. Pet care in minutes. "
                canonical="https://petric.in/terms-and-conditions"  
            />    
