...
export default function PrivacyPolicy() {
    ...
    return (
      <>
        <SEO
          title="Privacy Policy | Petric"
          description="Read Petric's privacy policy to understand how we collect, use and protect your personal data. Your privacy matters to us."
          canonical="https://petric.in/privacy-policy"
        />  
