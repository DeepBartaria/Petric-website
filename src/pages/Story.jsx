...
export default function Story() {
  ...
  return (
    <>
      <SEO
        title="Our Story | Petric; Made by Pet Parents for Pet Parents "
        description="Discover how Petric was built by pet parents for pet parents in Gurgaon. Our story is about making quality pet care accessible, fast and stress-free."
        canonical="https://petric.in/story"
      />
