...
export default function ProfileSidebar({ isOpen, onClose }) {
  ...
  useEffect(() => {
    if (isOpen) {
      logActivity('User Opened Account Page', 'Web_AccountPage');
  ...
  return (
    <>
      <div 
        ...
        onClick={onClose}
      />
      <div className="fixed top-0 right-0 h-[100dvh] w-full sm:w-[400px] bg-white z-50 flex flex-col shadow-2xl transform transition-transform duration-300 translate-x-0 font-sans">
