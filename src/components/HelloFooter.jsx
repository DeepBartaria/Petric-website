...
import cataloguePdf from '../assets/Petric_Product_Brochure.pdf';
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 text-black sm:px-6 md:px-8 py-6 sm:py-8">
          ...
          <div className="flex flex-col items-start text-left gap-4 col-span-1">
            ...
            <div className="flex gap-3 sm:gap-4 mt-2">
              <a href="https://www.facebook.com/profile.php?id=61574867466246&mibextid=rS40aB7S9Ucbxw6v" aria-label="Facebook" className=" text-white bg-black rounded-full p-2.5"><FaFacebookF size={18} className="sm:w-[20px] sm:h-[20px]" /></a>
              <a href="https://www.instagram.com/petric.in/" aria-label="Instagram" className=" text-white bg-black rounded-full p-2.5"><RiInstagramFill size={18} className="sm:w-[20px] sm:h-[20px]" fill='white' /></a>
              <a href="http://www.linkedin.com/in/petric-india-b4525935a" aria-label="LinkedIn" className=" text-white bg-black rounded-full p-2.5"><FaLinkedin size={18} className="sm:w-[20px] sm:h-[20px]" /></a>
              <a href="http://wa.me/918295756962" aria-label="WhatsApp" className=" text-white bg-black rounded-full p-2.5"><IoLogoWhatsapp size={18} className="sm:w-[20px] sm:h-[20px]" /></a>
            </div>
          </div>
          {/* Quick links */}
